...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DpczOYQx.mjs");
...
var manifest = {
	"591887ac263a82d6bcd7b39911ef4a3f25f93c6284d0e20d0958e4b0c5422b17": {
		functionName: "listConfessions_createServerFn_handler",
		importer: () => import("./confessions-DOoXGsG4.mjs")
	},
	"ed459cf7c28718224b019d4263f31f9bb582139d8f447c9d451986bd2be2da56": {
		functionName: "createConfession_createServerFn_handler",
		importer: () => import("./confessions-DOoXGsG4.mjs")
	},
	"ff7b1ff75fa3ba7f25c7a8efca4525ea92ac3024a7d1c0b778fe5fcd38fc46e3": {
		functionName: "upvoteConfession_createServerFn_handler",
		importer: () => import("./confessions-DOoXGsG4.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CuA23DbT.mjs").then((n) => n.t),
